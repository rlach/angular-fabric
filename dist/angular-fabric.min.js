...
function DirectiveController(e,t,c,r){var i=function(){r.setElement(c),r.createCanvas(),$("body").on("click","canvas",function(){fabric.setUserHasClickedCanvas&&fabric.setUserHasClickedCanvas(!0)}),e.$watch("fabric.canvasBackgroundColor",function(e){fabric.setCanvasBackgroundColor&&fabric.setCanvasBackgroundColor(e)}),e.$watch("fabric.selectedObject.text",function(e){"string"==typeof e&&(fabric.setText(e),fabric.render())}),e.$watch("fabric.selectedObject.fontSize",function(e){("string"==typeof e||"number"==typeof e)&&(fabric.setFontSize(e),fabric.render())}),e.$watch("fabric.selectedObject.lineHeight",function(e){("string"==typeof e||"number"==typeof e)&&(fabric.setLineHeight(e),fabric.render())}),e.$watch("fabric.selectedObject.textAlign",function(e){"string"==typeof e&&(fabric.setTextAlign(e),fabric.render())}),e.$watch("fabric.selectedObject.fontFamily",function(e){"string"==typeof e&&e&&(fabric.setFontFamily(e),fabric.render())}),e.$watch("fabric.selectedObject.opacity",function(e){("string"==typeof e||"number"==typeof e)&&(fabric.setOpacity(e),fabric.render())}),e.$watch("fabric.selectedObject.fill",function(e){"string"==typeof e&&(fabric.setFill(e),fabric.render())}),e.$watch("fabric.selectedObject.tint",function(e){"string"==typeof e&&(fabric.setTint(e),fabric.render())})};t(i,0)}angular.module("common.fabric.directive",["common.fabric.canvas"]).directive("fabric",["FabricCanvas",function(e){return{scope:{fabric:"="},controller:DirectiveController}}]),DirectiveController.$inject=["$scope","$timeout","$element","FabricCanvas"];
